 ...
 *6)emptycol         */
static const char *colors[] = {"#de935f","#333333","#7a8c5c","#ff6666","#cc9933","#1c1c1c","#000000"};
/*
...
///--Menus and Programs---///
static const char *menucmd[]   = { "~/bin/valikko", NULL };
static const char *gmrun[]     = { "~/bin/valikko",NULL};
